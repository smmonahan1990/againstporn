...
from .api_views import CustomVerify, CustomLogin, CustomLogout, CustomPasswordResetVerify, CustomPasswordResetVerified, CustomPasswordChange, permissions_check
...
urlpatterns = [
    ...
    path('permissions/',permissions_check, name="permissions"),
